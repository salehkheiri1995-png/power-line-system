$ cat > output/start-powerline.bat << 'EOF'
@echo off
chcp 65001 >nul
...
REM --- Kill old ngrok if running ---
taskkill /f /im ngrok.exe >nul 2>&1
timeout /t 1 /nobreak >nul

REM --- Write .env with localhost backend ---
...
REM --- Start ngrok for Frontend only ---
